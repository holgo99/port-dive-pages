/**
 * AITickerIntel - Premium Sidebar Component
 *
 ...
 *
 * Automatically consumes data from TickerIntelProvider context when available,
 * with fallback to legacy props for backward compatibility.
 *
 * @component
...
export function AITickerIntel({ ticker }) {
