      ...
      >
        {[
          ...
          >
            ...
            <div style={{ color: ind.color, fontSize: 10, fontWeight: 600 }}>
              {ind.status}
            </div>
          </div>
        ))}
